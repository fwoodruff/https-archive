...
public:
    ...
    std::array<uint8_t, 32> m_client_write_key;
    std::array<uint8_t, 32> m_server_write_key;
    
    std::array<uint8_t, 12> m_client_implicit_write_IV;
    std::array<uint8_t, 12> m_server_implicit_write_IV;
